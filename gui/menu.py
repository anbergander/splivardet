...
class Ui_Main(object):
    ...
    def setupUi(self, Group):
        ...
        self.pixmap = QPixmap("../../ressources/Logo.png")
        self.label.setPixmap(self.pixmap)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionDeTable.setText(_translate("MainWindow", "DGE Table"))
        self.actionDeHeatmap.setText(_translate("MainWindow", "DGE Heatmap"))
        self.actionProject.setText(_translate("MainWindow", "Project"))
        self.actionClose.setText(_translate("MainWindow", "Close"))
        self.actionDe.setText(_translate("MainWindow", "DGE Analysis"))
        self.actionGo.setText(_translate("MainWindow", "GSEA"))
        self.actionDePCA.setText(_translate("MainWindow", "DGE PCA"))
        self.actionDeVolcano.setText(_translate("MainWindow", "DGE Volcano or MA"))
        ...
        self.actionDeReport.setText(_translate("MainWindow", "Create Report for DGE Analysis"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.de), _translate("MainWindow", "DGE Table"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.GeneExpression), _translate("MainWindow", "DGE"))
